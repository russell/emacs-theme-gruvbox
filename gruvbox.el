...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light0))
     ...
     (diff-context                              (:background nil :foreground gruvbox-light1))
     (diff-added                                (:background gruvbox-dark1 :foreground gruvbox-neutral_green))
     (diff-refine-added                         (:background gruvbox-dark1 :foreground gruvbox-bright_green))
     (diff-removed                              (:background gruvbox-dark2 :foreground gruvbox-neutral_red))
     (diff-refine-removed                       (:background gruvbox-dark2 :foreground gruvbox-bright_red))
